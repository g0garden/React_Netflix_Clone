        ...
        <FooterWrap>
            ...
            <SocialLinks>
                <a href="https://www.facebook.com/NetflixKR">
                    <ImFacebook2  cursor="pointer" size="20" color="grey" />
                </a>
                <a href="https://www.instagram.com/netflixkr/">
                    <ImInstagram  cursor="pointer" size="20" color="grey" />
                </a>
                <a href="https://www.twitter.com/NetflixKR">
                    <ImTwitter  cursor="pointer" size="20" color="grey" />
                </a>
                <a href="https://www.youtube.com/NetflixKR">
                    <ImYoutube cursor="pointer" size="20" color="grey" />
                </a>
            </SocialLinks>
            <FooterInfoLinks>
                    <li>
            ...
            <NetflixInfo>
                <li>넷플릭스서비시스코리아 유한회사 통신판매업신고번호: 제2018-서울종로-0426호 전화번호:00-308-321-0058</li>
                <li>대표: 레지널드 숀 톰프슨</li>
